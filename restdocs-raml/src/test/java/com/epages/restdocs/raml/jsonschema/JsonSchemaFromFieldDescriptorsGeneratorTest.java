...
public class JsonSchemaFromFieldDescriptorsGeneratorTest {
    ...
    private void givenFieldDescriptorsWithConstraints() {
        final Attributes.Attribute constraintAttributeWithNotNull = Attributes.key("notImportant").value(singletonList(new Constraint(NotNull.class.getName(), emptyMap())));
        fieldDescriptors =  Arrays.asList(
                ...
                fieldWithPath("billingAddress.firstName").description("some").type(STRING).attributes(constraintAttributeWithNotNull),
